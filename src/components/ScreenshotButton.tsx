...
export function ScreenshotButton(props: ScreenshotButtonProps){
    ...
    if(props.screenshot){
        return (
            <button type="button"
                ...
                style={{
                    background:`url(${props.screenshot!})`
                }}
    ...
    return (
        <button type="button"
            ...
            className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinv-900 focus:ring-brand-500"
        >
